...
#junctions {
  [highway = 'motorway_junction'] {
    [zoom >= 11] {
      ...
      [zoom >= 15] {
        ref/text-size: @text-size-12;
        name/text-size: @text-size-11;
        name/text-dy: -10;
      }
    }
  }
  ...
  [highway = 'traffic_signals'] {
    [zoom >= 14] {
      ...
      text-min-distance: 2;
      [zoom >= 14] {
        text-size: @text-size-9;
      }
      [zoom >= 15] {
        text-size: @text-size-10;
      }
      [zoom >= 17] {
        text-size: @text-size-11;
